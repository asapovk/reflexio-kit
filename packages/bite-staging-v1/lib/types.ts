import { DefautOpts, DispatcherType, HookerType, WaiterType } from "@reflexio/core-v1/lib/types";
...
export interface Stage<O> {
  ...
  export interface StageProcessorOpts<Tg, St> {
    opt: Opts<Tg, St>;
    routes: any;
    failHandler: (opt: Opts<Tg, St>) => Promise<void> | void;
  }
